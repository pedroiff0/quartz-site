...
published: 2026-08-01 16:28:51.169000-03:00
cssclasses:
- page-layout
...
- **[[02-areas/academico/pesquisas/journal-clubs/mwbr/journal-club-mwbr|MWBR]]** — grupo de pesquisa em Via Láctea, arqueologia galáctica e populações estelares.
- **[[02-areas/academico/pesquisas/journal-clubs/engcomp/journal-club-engcomp|ENGCOMP]]** — journal club de Engenharia de Computação.
...
> Toda nota de artigo discutido segue a mesma estrutura. Esses campos alimentam sozinhos a tabela da página do grupo e o [[02-areas/academico/pesquisas/journal-clubs/engcomp/dashboard]] — basta criar a nota na pasta certa (`mwbr/` ou `engcomp/`) e ela aparece no próximo build.
>
