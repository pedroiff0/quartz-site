...
Ao lado da professora [Ana Cecília Soja](https://integra.iff.edu.br/p/ana-cecilia-soja), apresentei o trabalho **"[[pt-br/projects/Acadêmico/Anomaly_Detection/README|Stellar properties and chemical features of the Gaia Catalogue of Nearby Stars observed by GALAH DR4]]"** (pôster, análise de cerca de 6.000 estrelas com dados do satélite Gaia).
...
- [[pt-br/projects/Acadêmico/Anomaly_Detection/README|Detecção de Anomalias em Dados do Gaia]] — página de pesquisa completa do pôster apresentado aqui
