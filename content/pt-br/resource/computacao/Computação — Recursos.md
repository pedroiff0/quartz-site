...
- [[pt-br/resource/Engenharia de Computação/5-periodo/projeto-e-analise-de-algoritmos/Projeto e Análise de Algoritmos|Projeto e Análise de Algoritmos]] — Notação assintótica, divisão e conquista, programação dinâmica e algoritmos gulosos: como provar que uma solução é eficiente antes de rodar.
...
- [[pt-br/resource/Engenharia de Computação/6-periodo/comunicacao-de-dados/Comunicação de Dados|Comunicação de Dados]] — Sinais, modulação, meios de transmissão e detecção de erros: a física e a matemática por trás de qualquer rede.
...
- [[pt-br/resource/Engenharia de Computação/5-periodo/modelagem-de-dados/Modelagem de Dados|Modelagem de Dados]] — Entidade-relacionamento, normalização e o projeto conceitual que decide se o banco vai ser sólido ou um pântano de dados duplicados.
- [[pt-br/resource/Engenharia de Computação/6-periodo/banco-de-dados/Banco de Dados|Banco de Dados]] — SQL de verdade, transações, índices e ACID — do primeiro SELECT ao raciocínio de quem projeta o armazenamento de um sistema real.
